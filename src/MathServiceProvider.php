...
class MathServiceProvider extends ServiceProvider {
	...
	public function register()
	{
		$this->app->booting(function()
		{
			...
			$loader->alias('Math', 'AshrafSaeed\Math\Facades\Math');
		});

		$this->app->bind('ExecutionEngineInterface', '\AshrafSaeed\Math\Drivers\MathExecutionEngine');
		$this->app->singleton('SolutionEngineInterface', function($app) {
			return new \AshrafSaeed\Math\Drivers\EvalMathDriver($app->make('ExecutionEngineInterface'));
		});
